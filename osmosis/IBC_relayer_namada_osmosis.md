...
# Recreate IBC channel
Due to SE network waw halted and then relanch. IBC channels must be recreated.
```
hermes --config $HERMES_CONFIG \
  create channel \
  --a-chain $CHAIN_ID_A \
...
id: "shielded-expedition.88f17d1d14", channel_id: "channel-259"  
